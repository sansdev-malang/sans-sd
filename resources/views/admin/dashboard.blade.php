<x-admin-layout>
    <div class="p-6 space-y-6">
        @if(!$isAdmin)
            <div class="bg-amber-50 dark:bg-amber-950/30 border border-amber-200 dark:border-amber-900/60 rounded-xl p-4 text-xs font-mono text-slate-800 dark:text-slate-200 break-all">
